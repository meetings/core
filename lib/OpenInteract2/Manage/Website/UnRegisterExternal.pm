package OpenInteract2::Manage::Website::UnRegisterExternal;
...
sub get_brief_description {
    return "Removes external tool data from websites database";
}
...
sub run_task {
    ...
    foreach my $package_name ( @{ $self->param( 'package' ) } ) {
        ...
        $self->_unregisterer( 'externalsource', $package_name, 'name' );
    }
