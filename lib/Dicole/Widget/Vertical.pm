package Dicole::Widget::Vertical;

use strict;
use base qw( Dicole::Widget::Container );
use OpenInteract2::Context   qw( CTX );

sub DEFAULT_TEMPLATE { 'widget_vertical' };
...
Vertical items widget

=head1 SYNOPSIS

   my $container = Dicole::Widget::Vertical->new(
      contents => [ Dicole::Widget::Text->new( text => 'Hello', ... ) ]
);

=head1 DESCRIPTION

This is a general purpose vertical list class that can be used to make a vertical list of widgets that appear one after anoter.

Returns data in format understood by the template I<dicole_base::widget_vertical>.
