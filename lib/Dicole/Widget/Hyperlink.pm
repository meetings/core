package Dicole::Widget::Hyperlink;
...
sub DEFAULT_TEMPLATE { 'widget_hyperlink' };
...
sub ACCESSORS { (
    ...
    disable_click => Dicole::Widget::ACCESSOR_RAW,
) };
...
Antti Vähäkotamäki E<lt>antti@dicole.com<gt>
