package Dicole::Widget::FormControl::Checkbox;
...
my $button = Dicole::Widget::FormControl::Checkbox->new(
    name => 'check_me',
...
I<dicole_base::widget_formcontrol_checkbox>.
...
=head2 checked( [STRING] )

Wether checkbox is checked.

=cut

sub DEFAULT_TEMPLATE { 'widget_formcontrol_checkbox' };

sub ACCESSORS { (
    checked => Dicole::Widget::ACCESSOR_RAW,
) };
