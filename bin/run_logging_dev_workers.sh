...
timeout $[$RUNTIME+100] /usr/local/bin/oi2_manage dicole_eval --website=$WEBDIR --code='CTX->lookup_action("meetings_worker")->e( '$GROUP' => { run_for_seconds => '$RUNTIME', domain_id => '$DOMAIN', override_version => 1 } )' &
