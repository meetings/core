...
#   by:    /usr/local/bin/oi2_manage create_package --package=dicole_reset_theme
#   on:    Wed Jan 12 18:51:22 2011
#   from:  App.pm
#   using: OpenInteract2 version 1.99_07

package OpenInteract2::App::DicoleResetTheme;

use strict;
use base qw( Exporter OpenInteract2::App );
use OpenInteract2::Manage;

$OpenInteract2::App::DicoleResetTheme::VERSION = sprintf("%d.%02d", q$Revision: 1.6 $ =~ /(\d+)\.(\d+)/);
@OpenInteract2::App::DicoleResetTheme::EXPORT  = qw( install );

my $NAME = 'dicole_reset_theme';
...
OpenInteract2::App::DicoleResetTheme - This application will do everything!
