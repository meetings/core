package OpenInteract2::App::DicoleBase;

use strict;
use base qw( Exporter OpenInteract2::App );
use OpenInteract2::Manage;

$OpenInteract2::App::DicoleBase::VERSION = sprintf("%d.%02d", q$Revision: 1.2 $ =~ /(\d+)\.(\d+)/);
@OpenInteract2::App::DicoleBase::EXPORT  = qw( install );
...
OpenInteract2::App::DicoleBase - This application will do everything!

=head1 NAME

dicole_base - This package will do everything!
