package OpenInteract2::App::DicoleFeedreader;

use strict;
use base qw( Exporter OpenInteract2::App );
use OpenInteract2::Manage;

$OpenInteract2::App::DicoleFeedreader::VERSION = sprintf("%d.%02d", q$Revision: 1.1 $ =~ /(\d+)\.(\d+)/);
@OpenInteract2::App::DicoleFeedreader::EXPORT  = qw( install );

my $NAME = 'dicole_feedreader';
...
OpenInteract2::App::DicoleFeedreader - This application will do everything!
