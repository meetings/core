...
#   by:    /usr/local/bin/oi2_manage create_package --package=dicole_sessions
#   on:    Thu Jun 10 13:51:10 2010
#   from:  App.pm
#   using: OpenInteract2 version 1.99_07

package OpenInteract2::App::DicoleSessions;

use strict;
use base qw( Exporter OpenInteract2::App );
use OpenInteract2::Manage;

$OpenInteract2::App::DicoleSessions::VERSION = sprintf("%d.%02d", q$Revision: 1.1 $ =~ /(\d+)\.(\d+)/);
@OpenInteract2::App::DicoleSessions::EXPORT  = qw( install );

my $NAME = 'dicole_sessions';
...
OpenInteract2::App::DicoleSessions - This application will do everything!
