...
#   by:    /usr/local/bin/oi2_manage create_package --package=dicole_event_source
#   on:    Wed Dec  9 20:38:12 2009
#   from:  App.pm
#   using: OpenInteract2 version 1.99_07

package OpenInteract2::App::DicoleEventSource;

use strict;
use base qw( Exporter OpenInteract2::App );
use OpenInteract2::Manage;

$OpenInteract2::App::DicoleEventSource::VERSION = sprintf("%d.%02d", q$Revision: 1.1 $ =~ /(\d+)\.(\d+)/);
@OpenInteract2::App::DicoleEventSource::EXPORT  = qw( install );

my $NAME = 'dicole_event_source';
...
OpenInteract2::App::DicoleEventSource - This application will do everything!
