package OpenInteract2::App::DicoleChatUserplane;

use strict;
use base qw( Exporter OpenInteract2::App );
use OpenInteract2::Manage;

$OpenInteract2::App::DicoleChatUserplane::VERSION = sprintf("%d.%02d", q$Revision: 1.1.1.1 $ =~ /(\d+)\.(\d+)/);
@OpenInteract2::App::DicoleChatUserplane::EXPORT  = qw( install );

my $NAME = 'dicole_chat_userplane';
...
OpenInteract2::App::DicoleChatUserplane - This application will do everything!
