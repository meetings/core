package OpenInteract2::App::DicoleTag;

use strict;
use base qw( Exporter OpenInteract2::App );
use OpenInteract2::Manage;

$OpenInteract2::App::DicoleTag::VERSION = sprintf("%d.%02d", q$Revision: 1.1 $ =~ /(\d+)\.(\d+)/);
@OpenInteract2::App::DicoleTag::EXPORT  = qw( install );
...
OpenInteract2::App::DicoleTags - This application will do everything!
