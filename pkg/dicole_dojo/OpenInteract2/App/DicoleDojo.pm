...
#   by:    /usr/local/bin/oi2_manage create_package --package=dicole_dojo
#   on:    Mon May 18 13:18:10 2009
#   from:  App.pm
#   using: OpenInteract2 version 1.99_07

package OpenInteract2::App::DicoleDojo;

use strict;
use base qw( Exporter OpenInteract2::App );
use OpenInteract2::Manage;

$OpenInteract2::App::DicoleDojo::VERSION = sprintf("%d.%02d", q$Revision: 1.1 $ =~ /(\d+)\.(\d+)/);
@OpenInteract2::App::DicoleDojo::EXPORT  = qw( install );
...
OpenInteract2::App::DicoleDojo - This application will do everything!
