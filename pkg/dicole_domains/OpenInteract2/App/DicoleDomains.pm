...
package OpenInteract2::App::DicoleDomains;

use strict;
use base qw( Exporter OpenInteract2::App );
use OpenInteract2::Manage;

$OpenInteract2::App::DicoleDomains::VERSION = sprintf("%d.%02d", q$Revision: 1.1 $ =~ /(\d+)\.(\d+)/);
@OpenInteract2::App::DicoleDomains::EXPORT  = qw( install );

my $NAME = 'dicole_domains';
...
OpenInteract2::App::DicoleDomains - This application will do everything!
