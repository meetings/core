...
#   by:    /usr/local/bin/oi2_manage create_package --package=dicole_emails
#   on:    Wed Jan  5 17:09:32 2011
#   from:  App.pm
#   using: OpenInteract2 version 1.99_07

package OpenInteract2::App::DicoleEmails;

use strict;
use base qw( Exporter OpenInteract2::App );
use OpenInteract2::Manage;

$OpenInteract2::App::DicoleEmails::VERSION = sprintf("%d.%02d", q$Revision: 1.6 $ =~ /(\d+)\.(\d+)/);
@OpenInteract2::App::DicoleEmails::EXPORT  = qw( install );

my $NAME = 'dicole_emails';
...
OpenInteract2::App::DicoleEmails - This application will do everything!
