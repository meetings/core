...
function process_blogs_more() {
    dicole_xhrplace( {
        ...
        post_content_procedure : function ( node ) { return {
            page_load : dicole.blogs.gather_page_load_time(),
            shown_entry_ids : dicole.blogs.gather_shown_entry_ids_json()
        }; },
...
dicole.blogs.gather_shown_entry_ids_json = function() {
    var ids = [];
...
dicole.blogs.gather_page_load_time = function() {
