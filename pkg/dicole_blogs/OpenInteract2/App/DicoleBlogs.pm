...
#   by:    /usr/local/bin/oi2_manage create_package --package=dicole_blogs
#   on:    Fri Dec 28 03:14:48 2007
#   from:  App.pm
#   using: OpenInteract2 version 1.99_07

package OpenInteract2::App::DicoleBlogs;

use strict;
use base qw( Exporter OpenInteract2::App );
use OpenInteract2::Manage;

$OpenInteract2::App::DicoleBlogs::VERSION = sprintf("%d.%02d", q$Revision: 1.2 $ =~ /(\d+)\.(\d+)/);
@OpenInteract2::App::DicoleBlogs::EXPORT  = qw( install );

my $NAME = 'dicole_blogs';
...
OpenInteract2::App::DicoleBlogs - This application will do everything!
