...
#   by:    /usr/local/bin/oi2_manage create_package --package=dicole_networking
#   on:    Wed Jan 16 04:41:28 2008
#   from:  App.pm
#   using: OpenInteract2 version 1.99_07

package OpenInteract2::App::DicoleNetworking;

use strict;
use base qw( Exporter OpenInteract2::App );
use OpenInteract2::Manage;

$OpenInteract2::App::DicoleNetworking::VERSION = sprintf("%d.%02d", q$Revision: 1.2 $ =~ /(\d+)\.(\d+)/);
@OpenInteract2::App::DicoleNetworking::EXPORT  = qw( install );

my $NAME = 'dicole_networking';
...
OpenInteract2::App::DicoleNetworking - This application will do everything!
