...
#   by:    /usr/local/bin/oi2_manage create_package --package=dicole_cafe
#   on:    Mon Nov  2 16:46:15 2009
#   from:  App.pm
#   using: OpenInteract2 version 1.99_07

package OpenInteract2::App::DicoleCafe;

use strict;
use base qw( Exporter OpenInteract2::App );
use OpenInteract2::Manage;

$OpenInteract2::App::DicoleCafe::VERSION = sprintf("%d.%02d", q$Revision: 1.1 $ =~ /(\d+)\.(\d+)/);
@OpenInteract2::App::DicoleCafe::EXPORT  = qw( install );
...
OpenInteract2::App::DicoleCafe - This application will do everything!
