package OpenInteract2::App::DicoleDocumentation;

use strict;
use base qw( Exporter OpenInteract2::App );
use OpenInteract2::Manage;

$OpenInteract2::App::DicoleDocumentation::VERSION = sprintf("%d.%02d", q$Revision: 1.1 $ =~ /(\d+)\.(\d+)/);
@OpenInteract2::App::DicoleDocumentation::EXPORT  = qw( install );

my $NAME = 'dicole_documentation';
...
OpenInteract2::App::DicoleDocumentation - This application will do everything!
