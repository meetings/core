...
#   by:    /usr/local/bin/oi2_manage create_package --package=dicole_tinymce3
#   on:    Mon Feb  9 20:58:19 2009
#   from:  App.pm
#   using: OpenInteract2 version 1.99_07

package OpenInteract2::App::DicoleTinymceMeetings;

use strict;
use base qw( Exporter OpenInteract2::App );
use OpenInteract2::Manage;

$OpenInteract2::App::DicoleTinymceMeetings::VERSION = sprintf("%d.%02d", q$Revision: 1.1 $ =~ /(\d+)\.(\d+)/);
@OpenInteract2::App::DicoleTinymceMeetings::EXPORT  = qw( install );

my $NAME = 'dicole_tinymce_meetings';
...
OpenInteract2::App::DicoleTinymceMeetings - This application will do everything!
