...
#   by:    /usr/local/bin/oi2_manage create_package --package=dicole_random
#   on:    Mon Apr 19 19:44:41 2010
#   from:  App.pm
#   using: OpenInteract2 version 1.99_07

package OpenInteract2::App::DicoleRandom;

use strict;
use base qw( Exporter OpenInteract2::App );
use OpenInteract2::Manage;

$OpenInteract2::App::DicoleRandom::VERSION = sprintf("%d.%02d", q$Revision: 1.1 $ =~ /(\d+)\.(\d+)/);
@OpenInteract2::App::DicoleRandom::EXPORT  = qw( install );

my $NAME = 'dicole_random';
...
OpenInteract2::App::DicoleRandom - This application will do everything!
