...
#   by:    /usr/local/bin/oi2_manage create_package --package=dicole_events
#   on:    Mon Aug  3 18:09:06 2009
#   from:  App.pm
#   using: OpenInteract2 version 1.99_07

package OpenInteract2::App::DicoleEvents;

use strict;
use base qw( Exporter OpenInteract2::App );
use OpenInteract2::Manage;

$OpenInteract2::App::DicoleEvents::VERSION = sprintf("%d.%02d", q$Revision: 1.1 $ =~ /(\d+)\.(\d+)/);
@OpenInteract2::App::DicoleEvents::EXPORT  = qw( install );

my $NAME = 'dicole_events';
...
OpenInteract2::App::DicoleEvents - This application will do everything!
