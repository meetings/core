...
#   by:    /usr/local/bin/oi2_manage create_package --package=dicole_localization
#   on:    Mon May 25 17:17:43 2009
#   from:  App.pm
#   using: OpenInteract2 version 1.99_07

package OpenInteract2::App::DicoleLocalization;

use strict;
use base qw( Exporter OpenInteract2::App );
use OpenInteract2::Manage;

$OpenInteract2::App::DicoleLocalization::VERSION = sprintf("%d.%02d", q$Revision: 1.1 $ =~ /(\d+)\.(\d+)/);
@OpenInteract2::App::DicoleLocalization::EXPORT  = qw( install );

my $NAME = 'dicole_localization';
...
OpenInteract2::App::DicoleLocalization - This application will do everything!
