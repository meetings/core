...
package OpenInteract2::App::DicoleTinymce3;

use strict;
use base qw( Exporter OpenInteract2::App );
use OpenInteract2::Manage;

$OpenInteract2::App::DicoleTinymce3::VERSION = sprintf("%d.%02d", q$Revision: 1.1 $ =~ /(\d+)\.(\d+)/);
@OpenInteract2::App::DicoleTinymce3::EXPORT  = qw( install );

my $NAME = 'dicole_tinymce3';
...
OpenInteract2::App::DicoleTinymce3 - This application will do everything!
