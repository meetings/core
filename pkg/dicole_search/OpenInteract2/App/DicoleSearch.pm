...
#   by:    /usr/local/bin/oi2_manage create_package --package=dicole_search
#   on:    Tue May 26 13:32:36 2009
#   from:  App.pm
#   using: OpenInteract2 version 1.99_07

package OpenInteract2::App::DicoleSearch;

use strict;
use base qw( Exporter OpenInteract2::App );
use OpenInteract2::Manage;

$OpenInteract2::App::DicoleSearch::VERSION = sprintf("%d.%02d", q$Revision: 1.1 $ =~ /(\d+)\.(\d+)/);
@OpenInteract2::App::DicoleSearch::EXPORT  = qw( install );

my $NAME = 'dicole_search';
...
OpenInteract2::App::DicoleSearch - This application will do everything!
