...
package OpenInteract2::App::DicoleThumbnails;

use strict;
use base qw( Exporter OpenInteract2::App );
use OpenInteract2::Manage;

$OpenInteract2::App::DicoleThumbnails::VERSION = sprintf("%d.%02d", q$Revision: 1.1 $ =~ /(\d+)\.(\d+)/);
@OpenInteract2::App::DicoleThumbnails::EXPORT  = qw( install );

my $NAME = 'dicole_thumbnails';
...
OpenInteract2::App::DicoleThumbnails - This application will do everything!
