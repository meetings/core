...
#   by:    /usr/local/bin/oi2_manage create_package --package=dicole_comments
#   on:    Fri Jan  4 21:37:54 2008
#   from:  App.pm
#   using: OpenInteract2 version 1.99_07

package OpenInteract2::App::DicoleComments;

use strict;
use base qw( Exporter OpenInteract2::App );
use OpenInteract2::Manage;

$OpenInteract2::App::DicoleComments::VERSION = sprintf("%d.%02d", q$Revision: 1.2 $ =~ /(\d+)\.(\d+)/);
@OpenInteract2::App::DicoleComments::EXPORT  = qw( install );

my $NAME = 'dicole_comments';
...
OpenInteract2::App::DicoleComments - This application will do everything!
